        ...
        >
          ...
          >
            ...
            {[0.25, 0.5, 0.75].map((pct) => (
              ...
              >
                {formatCurrency(userProfile.monthlyIncome * (1 - pct))}
              </span>
            ))}

            {/* Flex Space (top portion) */}
            {flexSpace > 0 && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                ...
                style={{
                  height: `${(flexSpace / userProfile.monthlyIncome) * 100}%`,
                  display: 'flex',
                  alignItems: 'center',
            ...
            {/* Budget Blocks (stacked bottom-up, rendered top-down reversed) */}
            {[...budgetCategories].reverse().map((cat, i) => {
              const blockHeight =
                (cat.allocated / userProfile.monthlyIncome) * 100;
                ...
                >
                  ...
                  <motion.div
                    ...
                    style={{
                      ...
                      left: 0,
                      bottom: 0,
                      background: `linear-gradient(90deg, ${cat.color}40, ${cat.color}25)`,
